...
// pub fn build_vcf_header(template: &bcf::header::HeaderView) -> Result<bcf::Header, anyhow::Error> {
...
// pub fn collect_contigs(reader: &bcf::IndexedReader) -> Result<Vec<String>, anyhow::Error> {
